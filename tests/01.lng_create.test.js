...
describe('create app without internet', () => {
  ...
  it('should create app without internet', async () => {
    ...
    fs.removeSync(`./${global.appConfig.id}`);
    ...
    expect(inquirer.prompt.mock.calls).toHaveLength(6);
  ...
  it.todo('should create app without name')
  it.todo('should create app with invalid name')
